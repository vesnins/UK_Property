    ...
    <li class="villa-item">
      <div class="villa-item--cover">
        <div class="villa-img">
          ...
          <ul class="hashes">
            @if($val['villas_by_the_sea'])
              <li>@lang('main.villas_by_the_sea')</li>@endif
            @if($val['is_hot'])
              <li>@lang('main.is_hot_offer')</li>@endif
            @if($val['villas_with_private_service'])
              <li>@lang('main.villas_with_private_service')</li>@endif
            @if($val['vacation_together'])
              <li>@lang('main.vacation_together')</li>@endif
          </ul>
