			...
			<div class="container">
				...
				<div class="about-info">
					<div class="info-item">
						...
						<div class="text-box">
							<p>UK Property Advisors Ltd is an independent property buying agent. We focus on providing practical solutions to international clients who consider to invest into London properties. We are entirely privately owned and are led by Nataliya Makhon- ina-Byrdan who is fully involved in our activities on a day-to-day and strategic basis. We represent Buyers and Investors exclusively in all property transactions and strive for getting best deals for our clients.</p>
					...
					<div class="info-item">
						...
						<div class="text-box">
							<p>This is what fundamentally distinguish us from high-street real-estate agents that are hired by Sellers to maximize profit from home sales. Since 2010 Nataliya is investing into London property market. She got her expertise thorough analysis of historical and current market data and fulfilment of different investment strategies. Throughout the years she cooperated with various local property experts and gained an invaluable practical experience alongside with UK legislation knowledge.</p>
							<p>We utilise the most up-to-date data and analytical reports available on the London and UK housing market that is also used by Bloomberg, Financial Times, Nationwide Building Society and major UK mortgage providers and international banks. UK Property Advisors is a member of the UK Property Redress and Tenancy Deposit Schemes</p>
						</div>
					</div>
					<div class="info-item">
						<div class="img-box">
						...
						<div class="text-box">
							<blockquote class="blockquote">
								<p>When considering a specific property investment opportunity it is critical to understand fair and worst case property valuation when the market will change, transactional risks and possible pitfalls, structure of the deal, taxation, legal and other associated costs, the basis for future increase in the property value, upcoming changes in UK legislation and step-by-step buying process.</p>
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
						...
						<p>We utilise the most up-to-date data and analytical reports available on the London and UK housing  market that is also used by Bloomberg, Financial Times, Nationwide Building Society and major UK  mortgage providers and international banks. </p>
				...
				<div class="testimonials-slider">
					...
					<div>
						<div class="inner-box">
							...
							<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet, ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus. Et harum quidem rerum facilis est et expedita distinctio. Itaque earum rerum hic tenetur a sapiente delectus. Et harum quidem rerum facilis est et expedita distinctio.</p>
						</div>
					</div>
					<div>
						<div class="inner-box">
