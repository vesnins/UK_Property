              ...
              @foreach($vacancies as $val)
                <li>
                  <a href="/vacancies/{{ $val['id'] }}">
                    ...
                    <span class="arrow">
                      <svg>
                        <use xlink:href="/images/svg/sprite.svg#ico_arrow-right-small"></use>
                      </svg>
                    </span>
                  </a>
                </li>
  ...
  <div class="modal">
    ...
    <div class="modal--main">
      <div class="resume-form" data-modal="resume-form">
        <span class="close">
          <svg>
            <use xlink:href="/images/svg/sprite.svg#ico_close"></use>
          </svg>
        </span>
                  ...
                  <i>
                    <svg>
                      <use xmlns:xlink="http://www.w3.org/1999/xlink"
                        xlink:href="/images/svg/sprite.svg#ico_submit"></use>
                    </svg>
                  </i>
                </button>
              </div>
